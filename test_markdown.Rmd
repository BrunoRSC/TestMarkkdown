...
![Alt text](D:/Users/bruno/Documents/pos_doc/ftp_eta/2015/2015010100/prec_Eta20km2015010100_mask_2.png) Figura 2. Coleção de objetos `RasterLayer` com resolução horizontal de 20 km contidas em um objeto `RasterStack` contendo as previsões de precipitação obtidas pelo modelo Eta para os 60 dias consecutivos a partir do dia 01/02015, recortadas para a extensão da bacia do Rio São Francisco.
